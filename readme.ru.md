...
##### «custom_header» `[string]`
- Вставляется как HTML в начало всех страниц «загрузка отказана». Это может быть полезно, если вы хотите включить логотип веб-сайта, персонализированный заголовок, скрипты, или подобное на всех таких страницах.

##### «custom_footer» `[string]`
- Вставляется как HTML в конце всех страниц «загрузка отказана». Это может быть полезно, если вы хотите включить юридическое уведомление, контактную ссылку, деловую информацию, или подобное на всех таких страницах.
