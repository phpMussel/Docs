...
##### «entropy_filesize_limit» `[string]`
- Предел размера файла энтропии для сигнатурей, использующих нормализованные данные (стандарт 512КБ). При оба превышении предела энтропии и предела размера файла энтропии, чтобы снизить риск ложноположительный, некоторые сигнатуры, использующие нормализованные данные, будут игнорироваться.
...
Последнее обновление: 30 Марта 2025 г (2025.03.30).
