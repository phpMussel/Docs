...
![Скриншот](https://raw.githubusercontent.com/phpMussel/extras/master/screenshots/cli-v3.4.1.png)
...
Полезный совет: Вы можете прикрепить информацию о дате и времени к именам файлов журналов, используя заполнители формата времени. Доступные заполнители формата времени отображаются на {{Links.ConfigRef.time_format}}.
...
Последнее обновление: 22 Июня 2024 г (2024.06.22).
