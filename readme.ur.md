...
<div dir="rtl"><ul><li>فائلوں کے آغاز اور اختتام پر نقطہ نظر کی اجازت دیں؟ یہ کبھی کبھی استعمال کرنے کے لیے فائلوں کو چھپانے کے لیے، یا کچھ نظام کو ڈائل کرنے کے لیے استعمال کیا جا سکتا ہے ڈائرکٹری کے تبادلوں کی اجازت دیتا ہے. False (جھوٹی) = اجازت نہ دیں [پہلے سے طے شدہ]؛ True (سچے) = اجازت دیں.</li></ul></div>
