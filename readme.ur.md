...
مفید مشورہ: آپ ٹائم فارمیٹ پلیس ہولڈرز کا استعمال کرکے لاگ فائلوں کے ناموں کے ساتھ تاریخ/وقت کی معلومات منسلک کرسکتے ہیں. دستیاب وقت کی شکل کے پلیس ہولڈرز {{Links.ConfigRef.time_format}} پر دکھائے جاتے ہیں.
...
<div dir="rtl">آخری تازہ کاری: ۲۲ جون ۲۰۲۴ (۲۰۲۴.۰۶.۲۲).</div>
